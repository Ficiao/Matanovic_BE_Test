...
namespace LibSample
{
    class AesEncryptionTest : IExample
    {
        ...
        private void AesLayerEncryptDecrypt()
        {
            ...
            RandomNumberGenerator keyGen = RandomNumberGenerator.Create();
            ...
            AesEncryptLayer outboudLayer = new AesEncryptLayer(key);
            ...
            AesEncryptLayer inboundLayer = new AesEncryptLayer(key);
            ...
            bool isEqualLength = expectedPlaintext.Length == length;
            bool areContentEqual = expectedPlaintext.SequenceEqual(inboundData);
