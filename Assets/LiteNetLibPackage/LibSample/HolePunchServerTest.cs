...
namespace LibSample
{
    ...
    class HolePunchServerTest : IExample, INatPunchListener
    {
        ...
        public void Run()
        {
            ...
            {
                NetPeer peer = _c1.Connect(point, ConnectionKey);
            ...
            {
                NetPeer peer = _c2.Connect(point, ConnectionKey);
            ...
            while (true)
            {
                ...
                //check old peers
                foreach (KeyValuePair<string, WaitPeer> waitPeer in _waitingPeers)
                {
